...
public class UpdateClassAttendanceData implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            ...
            ClassAttendanceData classAttendanceData = lambdaService.updateClassAttendanceData(
                    deserializedValue.getUserId(),
                    deserializedValue.getClassId(),
                    deserializedValue.getAttendanceStatus());
