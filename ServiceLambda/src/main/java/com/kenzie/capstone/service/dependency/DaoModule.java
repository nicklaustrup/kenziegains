...
//            @Named("NonCachingDao")NonCachingDao nonCachingDao) {
...
//    @Named("NonCachingDao")
//    @Inject
//    public NonCachingDao nonCachingDao(@Named("DynamoDBMapper") DynamoDBMapper mapper) {
//        return new NonCachingDao(mapper);
//    }
}
