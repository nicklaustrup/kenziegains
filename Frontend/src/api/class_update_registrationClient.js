...
export default class RegistrationCreateClient extends BaseClass {
    ...
    constructor(props = {}) {
        super();
        const methodsToBind = ['clientLoaded', 'getClass', 'getUser', 'getUsers', 'getAttendance', 'updateRegistration'];
    ...
    async updateRegistration(classId, userId, classAttendance, errorCallback) {
        try {
            const response = await this.client.put(`/classAttendance`, {
                classId: classId,
                userId: userId,
